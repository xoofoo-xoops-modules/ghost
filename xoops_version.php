 ...
 * @version	$Id: xoops_version.php 1458 2013-02-03 23:30:46Z kris_fr $
**/
...
$modversion["module_release"]			= "3 Fev. 2013";
...
$i = 1;
$modversion["config"][$i]["name"]		= "ghostconf1"; // site name
...
$i++;
$modversion["config"][$i]["name"]		= "ghostconf2"; // for title page 1
...
//$modversion["config"][$i]["category"]       = "";
$i++;
$modversion["config"][$i]["name"]		= "ghostconf3"; // meta keywords page 1
$modversion["config"][$i]["title"]			= "_MI_GHOST_CONF3";
$modversion["config"][$i]["description"]	= "_MI_GHOST_CONF3_DESC";
$modversion["config"][$i]["formtype"]		= "textarea";
$modversion["config"][$i]["valuetype"]		= "textarea";
$modversion["config"][$i]["default"]		= _MI_GHOST_CONF3_DEFAULT;
//$modversion["config"][$i]["options"]        = array( );
//$modversion["config"][$i]["category"]       = "";
$i++;
$modversion["config"][$i]["name"]		= "ghostconf4"; // meta description page 1
$modversion["config"][$i]["title"]			= "_MI_GHOST_CONF4";
$modversion["config"][$i]["description"]	= "_MI_GHOST_CONF4_DESC";
$modversion["config"][$i]["formtype"]		= "textarea";
$modversion["config"][$i]["valuetype"]		= "textarea";
$modversion["config"][$i]["default"]		= _MI_GHOST_CONF4_DEFAULT;
//$modversion["config"][$i]["options"]        = array( );
//$modversion["config"][$i]["category"]       = "";
$i++;
$modversion["config"][$i]["name"]		= "ghostconf5"; // title page 2
$modversion["config"][$i]["title"]			= "_MI_GHOST_CONF5";
$modversion["config"][$i]["description"]	= "_MI_GHOST_CONF5_DESC";
$modversion["config"][$i]["formtype"]		= "textbox";
$modversion["config"][$i]["valuetype"]		= "text";
$modversion["config"][$i]["default"]		= _MI_GHOST_CONF5_DEFAULT;
//$modversion["config"][$i]["options"]        = array( );
//$modversion["config"][$i]["category"]       = "";
$i++;
$modversion["config"][$i]["name"]		= "ghostconf6"; // meta keywords page 2
$modversion["config"][$i]["title"]			= "_MI_GHOST_CONF6";
$modversion["config"][$i]["description"]	= "_MI_GHOST_CONF6_DESC";
$modversion["config"][$i]["formtype"]		= "textarea";
$modversion["config"][$i]["valuetype"]		= "textarea";
$modversion["config"][$i]["default"]		= _MI_GHOST_CONF6_DEFAULT;
//$modversion["config"][$i]["options"]        = array( );
//$modversion["config"][$i]["category"]       = "";
$i++;
$modversion["config"][$i]["name"]		= "ghostconf7"; // meta description page 2
$modversion["config"][$i]["title"]			= "_MI_GHOST_CONF7";
$modversion["config"][$i]["description"]	= "_MI_GHOST_CONF7_DESC";
$modversion["config"][$i]["formtype"]		= "textarea";
$modversion["config"][$i]["valuetype"]		= "textarea";
$modversion["config"][$i]["default"]		= _MI_GHOST_CONF7_DEFAULT;
//$modversion["config"][$i]["options"]        = array( );
//$modversion["config"][$i]["category"]       = "";
